...
import {  CometChatDetails, CometChatMessageHeader, CometChatUsersWithMessages, MessageHeaderConfiguration, MessageListConfiguration } from '@cometchat/chat-uikit-angular'; //import the component in your module.ts file
